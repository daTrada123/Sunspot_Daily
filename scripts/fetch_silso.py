...
Behavior:
- If TARGET_FILENAME has no extension, ".csv" will be appended.
- Default TARGET_FILENAME is "Sunspot-Daily" -> becomes "Sunspot-Daily.csv".
...
# Accept target filename with or without .csv; append .csv if missing
...
def main() -> int:
    ...
    # Archive previous copy if requested
